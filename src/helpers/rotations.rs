    ...
    speculate! {
        describe "Rotation Matrix" {
            ...
            before {
                ...
                let _c3_90 = Matrix3::new(
                    0.00000000000000006123233995736766, 1., 0.,
                    -1., 0.00000000000000006123233995736766, 0.,
                    0., 0., 1.
                );

                let _c1c2 = Matrix3::new(
                    0.000000000000000000000000000000003749399456654644,  0.00000000000000006123233995736766,  1.,
                    -0.00000000000000012246467991473532, -1.,  0.00000000000000006123233995736766,
                    1.,  -0.00000000000000012246467991473532,  0.000000000000000000000000000000003749399456654644,
                );
            }
            ...
            it "can do C3 rotation" {
                assert_eq!(c3(90.), _c3_90)           
            }
            
            it "can multiply rotations" {
                println!("HERE: {:#?}", c1(90.) * c2(-90.) * c3(90.));
                assert_eq!(c1(90.) * c2(-90.) * c3(90.), _c1c2)
            }
        }
    }
}